codeunit 50150 "Barcode Management"
{
    ...
    trigger OnRun()
    var
        lrecTmpBlob: Record "Name/Value Buffer" temporary;
    begin
    end;
    ...
    procedure EncodeEAN13(pcodBarcode: Code[250]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "Name/Value Buffer" temporary)
    var
    ...
    begin
        ...
        precTmpTempBlob."Value BLOB".CreateOutStream(loutBmpHeader);
    ...
    procedure EncodeCode128(pcodBarcode: Code[1024]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "Name/Value Buffer" temporary)
    var
        lrecTmpCode128: Record "Barcode 128/39" temporary;
        lintCount1: Integer;
    ...
    procedure EncodeCode39(pcodBarcode: Code[1024]; pintSize: Integer; pblnCheckDigit: Boolean; pblnVertical: Boolean; var precTmpTempBlob: Record "Name/Value Buffer" temporary)
    var
        lrecTmpCode39: Record "Barcode 128/39" temporary;
        lintCount1: Integer;
        lintSum: Integer;
        lintConvInt: Integer;
        lintCheckDigit: Integer;
    ...
    procedure EncodeEAN8(pcodBarcode: Code[250]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "Name/Value Buffer" temporary)
    var
        ltxtWeight: Text[12];
        ltxtSentinel: Text[3];
        ltxtCenterGuard: Text[6];
    ...
    local procedure InitCode128(var precTmpCode128: Record "Barcode 128/39" temporary)
    begin
        precTmpCode128.Init;
    ...
    local procedure InitCode39(var precTmpCode39: Record "Barcode 128/39" temporary)
    begin
