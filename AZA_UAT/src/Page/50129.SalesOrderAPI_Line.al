page 50129 SalesLinePage_API
{
    PageType = API;
    Caption = 'SalesOrderAPI_Line';
    APIPublisher = 'CCIT';
    ...
    layout
    {
        area(Content)
        {
            repeater(GroupName)
            {
                ...
                part(ActionStatus; ActionStatus_Sales)
                {
                    ApplicationArea = all;
                    Caption = 'Lines', Locked = true;
                    EntityName = 'actionStatus_SO';
                    EntitySetName = 'actionStatus_SO_API';
                    SubPageLink = SO_ID = field(order_id);
                }
                // field(Line_Created; Rec."Line Created")
                // {
                //     ApplicationArea = all;
                // }
                // part(action)
