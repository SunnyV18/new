page 50165 "LSC Posted Cust. Order Header"
{
    Caption = 'LSC Posted CO Header Store';
    PageType = Worksheet;
    SourceTable = "LSC Posted CO Header";
    UsageCategory = Lists;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Refund Status field.';
                }
                ...
                field("Total refund on POS"; Rec."Total refund on POS")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Total refund on POS field.';
                }
