page 50148 "LSC Customer order Paym Store"
{
    ApplicationArea = All;
    Caption = 'LSC Customer order Paym Store';
    PageType = List;
    SourceTable = "LSC Customer Order Payment";
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Payment Registered (Internal) field.';
                }
